...
static const CGFloat kViewGap = 21.0;
...
{
    // 亮度图标
    UIImageView *brightnessImageView = [[UIImageView alloc] initWithFrame:CGRectMake((kVideoBrightnessIndicatorViewSide - 50) / 2, kViewGap, 50, 50)];
    ...
    UIView *blockBackgroundView = [[UIView alloc] initWithFrame:CGRectMake((kVideoVolumeIndicatorViewSide - 105) / 2, 50 + kViewGap * 2, 105, 2.75 + 2)];
